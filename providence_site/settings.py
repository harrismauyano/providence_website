...
SECRET_KEY = 'django-insecure-cs@l2#1s22_44bgzfh$ad@9r=5mec(#ak+mxm95@z_)32hjc4('
DEBUG = True
ALLOWED_HOSTS = ['*']
...
ROOT_URLCONF = 'providence_site.urls'
...
WSGI_APPLICATION = 'providence_site.wsgi.application'
